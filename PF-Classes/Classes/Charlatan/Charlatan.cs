...
namespace PF_Classes.Classes.Charlatan
{
    public class Charlatan : CharacterClass
    {
        ...
        private new BlueprintSpellbook Spellbook(BlueprintCharacterClass charlatan_class)
        {
            ...
            charlatanSpellList.SpellsByLevel[1].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_LIGHT_WOUNDS_CAST));
            charlatanSpellList.SpellsByLevel[1].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_I_SINGLE));
            charlatanSpellList.SpellsByLevel[2].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_MODERATE_WOUNDS_CAST));
            charlatanSpellList.SpellsByLevel[2].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_II_BASE));
            charlatanSpellList.SpellsByLevel[2].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_MAGE_ARMOR));
            charlatanSpellList.SpellsByLevel[2].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_DELAY_POISON));
            charlatanSpellList.SpellsByLevel[3].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_SERIOUS_WOUNDS_CAST));
            charlatanSpellList.SpellsByLevel[3].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_III_BASE));
            charlatanSpellList.SpellsByLevel[3].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_RESTORATION_LESSER));
            charlatanSpellList.SpellsByLevel[4].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_CRITICAL_WOUNDS_CAST));
            charlatanSpellList.SpellsByLevel[4].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_IV_BASE));
            charlatanSpellList.SpellsByLevel[4].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_DELAY_POISON_COMMUNAL));
            charlatanSpellList.SpellsByLevel[5].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_LIGHT_WOUNDS_MASS));
            charlatanSpellList.SpellsByLevel[5].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_V_BASE));
            charlatanSpellList.SpellsByLevel[5].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_RESTORATION));
            charlatanSpellList.SpellsByLevel[6].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_MODERATE_WOUNDS_MASS));
            charlatanSpellList.SpellsByLevel[6].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_VI_BASE));
            charlatanSpellList.SpellsByLevel[6].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_NEUTRALIZE_POISON));
            charlatanSpellList.SpellsByLevel[7].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_SERIOUS_WOUNDS_MASS));
            charlatanSpellList.SpellsByLevel[7].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_VII_BASE));
            charlatanSpellList.SpellsByLevel[5].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_RESTORATION_GREATER));
            charlatanSpellList.SpellsByLevel[8].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_CURE_CRITICAL_WOUNDS_MASS));
            charlatanSpellList.SpellsByLevel[8].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_VIII_BASE));
            charlatanSpellList.SpellsByLevel[9].Spells.Add(_spellbookRepository.GetSpell(Spells.CONJURATION_SUMMON_MONSTER_IX_BASE));
