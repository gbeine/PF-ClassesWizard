...
namespace PF_Classes.JsonType
{
    ...
    public class CharacterClassTest
    {
        ...
        public void TestCharacterClassNoOptional()
        {
            ...
            Assert.IsNull(characterClass.ComponentsArray);
            Assert.IsNull(characterClass.StartingItems);
